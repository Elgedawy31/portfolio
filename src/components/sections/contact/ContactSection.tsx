    ...
    <section className="relative py-16 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-foreground">
        <div className="flex items-center space-x-4 mb-8">
          <h2 className="text-4xl font-bold text-foreground">READY TO COLLABORATE?</h2>
          <Users className="w-10 h-10 text-foreground" />
        </div>
        <p className="text-foreground mb-8">HAVE A PROJECT IN MIND? LET'S CREATE SOMETHING EXTRAORDINARY TOGETHER</p>
